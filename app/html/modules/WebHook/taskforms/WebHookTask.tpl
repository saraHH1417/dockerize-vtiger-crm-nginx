...
<script src="layouts/v7/modules/WebHook/resources/Workflows.js" type="text/javascript" charset="utf-8"></script>
    <div class="row margin-tb-20">
        <div class="col-md-2">{vtranslate('Description',$WHMODULE)}<span class="redColor">*</span></div>
        <div class="col-md-10">
    ...
    <div class="row margin-tb-20">
        <div class="col-md-2">{vtranslate('HTTP Method',$WHMODULE)}<span class="redColor">*</span></div>
        <div class="col-md-10">
            <select class="select2 task-fields col-md-4" name="notify_method" data-validation-engine='validate[required]'>
    ...
    <div class="row margin-tb-20">
        <div class="col-md-2">{vtranslate('URL To Notify',$WHMODULE)}<span class="redColor">*</span></div>
        <div  id="urlfields" class="col-md-2">
            <select class="select2 task-fields" style="min-width: 150px;">
                {$ALL_FIELD_OPTIONS}
            </select>
        </div>
        <div id="webhook_url_div"  class="col-md-8">
            <input type="text" name="webhook_url" id="webhook_url" value="{$TASK_OBJECT->webhook_url}" data-validation-engine='validate[required]' data-rule-required="true" class="inputElement url  fields" placeholder="{vtranslate('Enter Request Url',$WHMODULE)}" style="width:{if $TASK_OBJECT->content_type neq 'SOAP'}99{else}65{/if}%; direction:ltr; text-align:left;"><input id="getfunctionurls" class="btn btn-primary" style="width:200px;{if $TASK_OBJECT->content_type neq 'SOAP'}display:none;{/if}" value="{vtranslate('Get list of WSDL url functions', $WHMODULE)}">
            <div id="urlstatus" class="alert alert-danger" style="display:none; text-align:center"></div>
        </div>
    </div>


    <div class="row margin-tb-20 padding-bottom1per" id="content_types" {if $TASK_OBJECT->content_type eq ''}style="display:none"{/if}>
        <div class="col-md-2">{vtranslate('Content Type',$WHMODULE)}<span class="redColor">*</span></div>
        <div class="col-md-10">
            <select class="select2 task-fields" name="content_type" data-validation-engine='validate[required]' id="content_type" style="width:30%;height:31px;">
    ...
    <div class="row margin-tb-20 padding-bottom1per" id="display_soap_version" {if $TASK_OBJECT->content_type neq 'SOAP'}style="display:none"{/if}>
        <div class="col-md-2">{vtranslate('Soap Version',$WHMODULE)}<span class="redColor">*</span></div>
        <div class="col-md-10">
            <select class="select2 task-fields" name="soap_version" data-validation-engine='validate[required]' id="soap_version" style="width:30%;height:31px;">
                <option value="Auto" {if $TASK_OBJECT->soap_version eq 'Auto' or $TASK_OBJECT->soap_version eq ''}selected{/if}>{vtranslate('Auto Detect',$WHMODULE)}</option>
                <option value="1.0" {if $TASK_OBJECT->soap_version eq '1.0'}selected{/if}>{vtranslate('1.0',$WHMODULE)}</option>
                <option value="1.1" {if $TASK_OBJECT->soap_version eq '1.1'}selected{/if}>{vtranslate('1.1',$WHMODULE)}</option>
                <option value="1.2" {if $TASK_OBJECT->soap_version eq '1.2'}selected{/if}>{vtranslate('1.2',$WHMODULE)}</option>
            </select>
        </div>
    </div>
    ...
    <div class="row margin-tb-20  padding-bottom1per" id="authentication_types" {if $TASK_OBJECT->authentication_type eq ''}style="display:none"{/if}>
        <div class="col-md-2">{vtranslate('Authorization type',$WHMODULE)}<span class="redColor">*</span></div>
        <div class="col-md-10">
            <select class="select2 task-fields" name="authentication_type" id="authentication_type" data-validation-engine='validate[required]' style="width:30%;height:31px;">
    ...
    <div class="row margin-tb-20 OauthenticationDiv  padding-bottom1per" {if $TASK_OBJECT->authentication_type neq 'CUSTOM' && $TASK_OBJECT->authentication_type neq '' && $TASK_OBJECT->authentication_type neq 'NO'}{else}style='display: none;'{/if}>
        <div class="row margin-tb-20 padding-bottom1per">
            <div class="col-md-2 padding-bottom1per">{vtranslate('Username',$QUALIFIED_MODULE)}</div>
            <div class="col-md-10 padding-bottom1per">
        ...
        <div class="row margin-tb-20 padding-bottom1per">
            <div class="col-md-2">{vtranslate('Password',$WHMODULE)}</div>
            <div class="col-md-10">
    ...
    <div class="row margin-tb-20 CauthenticationDiv  padding-bottom1per" {if $TASK_OBJECT->authentication_type eq 'CUSTOM'}{else}style='display: none;'{/if}>
        <div class="col-md-2">{vtranslate('Custom Token',$WHMODULE)}</div>
        <div class="col-md-10">
    ...
    <div class="row margin-tb-20  padding-bottom1per">
        <div class="col-md-2">{vtranslate('Update Fields on Successful Response',$WHMODULE)}<span class="redColor">*</span></div>
        <div class="col-md-10">
            <select class="select2 task-fields" name="use_response" data-validation-engine='validate[required]' id="use_response" style="width:30%;height:31px;">
    ...
    <div id="advoptions">
        <div class="row margin-tb-20  padding-bottom1per">
            <div class="col-md-2">{vtranslate('Disable the SSL check?',$WHMODULE)}</div>
            <div class="col-md-10">
        ...
        <div class="row margin-tb-20  padding-bottom1per">
            <div class="col-md-2">{vtranslate('Request timeout in seconds',$WHMODULE)}</div>
            <div class="col-md-10">
    ...
    <div id="soapptions">
        <div class="row margin-tb-20  padding-bottom1per">
            <div class="col-md-2">{vtranslate('String to Array Separator',$WHMODULE)}</div>
            <div class="col-md-10">
    ...
    <div id="addfields"  {if $TASK_OBJECT->notify_method eq '' || $TASK_OBJECT->webhook_url eq '' || $TASK_OBJECT->authentication_type eq ''}style="display:none"{/if}>
        <hr>
        <div class="row margin-tb-20">
            <div class="col-md-2"><strong>{vtranslate('Set Field Values',$WHMODULE)}</strong></div>
        </div>
        <br>
        <div>
        ...
        <br>
        <div class="row margin-tb-20 conditionsContainer" id="save_fieldvaluemapping">
            ...
            {foreach from=$FIELD_VALUE_MAPPING item=FIELD_MAP}
                <div class="row margin-tb-20 conditionRow padding-bottom1per">
        ...
        <span class="col-md-4">
                    ...
                    <span class="fieldUiHolder col-md-4 marginLeftZero">
                            ...
                            <input type="text" class="getPopupUi inputElement row" name="fieldValue" {*data-rule-required="true"*} value="{$FIELD_MAP['value']}" placeholder="{vtranslate('Parameter Value',$WHMODULE)}"/>
        ...
        <br>
        <div class="row margin-tb-20 basicAddFieldContainer hide padding-bottom1per">
    ...
    <span class="col-md-4">
            ...
            <span class="fieldUiHolder col-md-4 marginLeftZero">
                            ...
                            <input type="text" class="getPopupUi inputElement row" name="fieldValue" {*data-rule-required="true"*} value="" placeholder="{vtranslate('Parameter Value',$WHMODULE)}"/>
    ...
    <div id="addheaderfields"  {if $TASK_OBJECT->notify_method eq '' || $TASK_OBJECT->webhook_url eq '' || $TASK_OBJECT->authentication_type eq ''}style="display:none"{/if}>
        <hr>
        <div class="row margin-tb-20">
            <div class="col-md-2"><strong>{vtranslate('Set Header Values',$WHMODULE)}</strong> - {vtranslate('if needed',$WHMODULE)}</div>
        </div>
        <br>
        <div>
        ...
        <br>
        <div class="row margin-tb-20 conditionsContainer" id="save_headervaluemapping">
            {assign var=HEADER_VALUE_MAPPING value=ZEND_JSON::decode(html_entity_decode($HEADERVALUES))}
        ...
        <br>
        <div class="row margin-tb-20 HeaderAddFieldContainer hide padding-bottom1per">
    ...
    <div id="addresponsefields"  {if $TASK_OBJECT->use_response neq '1'}style="display:none"{/if}>
        <hr>
        <div class="row margin-tb-20">
            <div class="col-md-2"><strong>{vtranslate('Update CRM Fields Values',$WHMODULE)}</strong></div>
        </div><br>
        <div>
            <button type="button" class="btn" id="addUpdateFieldBtn">{vtranslate('Add Field',$WHMODULE)}</button>
        </div><br>
        <div class="row margin-tb-20 conditionsContainer" id="save_updatevaluemapping">
            {assign var=UPDATE_VALUE_MAPPING value=ZEND_JSON::decode(html_entity_decode($UPDATEVALUES))}
            ...
            {foreach from=$UPDATE_VALUE_MAPPING item=FIELD_MAP}
                <div class="row margin-tb-20 conditionRow padding-bottom1per">
				<span class="col-md-4">
					<select name="fieldname" class="select2 task-fields" style="min-width: 250px" data-placeholder="{vtranslate('LBL_SELECT_FIELD',$QUALIFIED_MODULE)}">
						<option></option>
                    ...
                    <span class="fieldUiHolder col-md-4 marginLeftZero">
                                <input type="text" class="inputElement row" name="fieldValue" {*data-rule-required="true"*} value="{$FIELD_MAP['value']}" placeholder="[0]"  style="direction:ltr;text-align:left;"/>
				</span>
                    <span class="cursorPointer">
					<i class="alignMiddle deleteCondition fa fa-trash"></i>
				</span>
                    <span class="fieldUiHolder col-md-2 marginLeftZero"  style="display: none;direction:ltr;text-align:right;">$RESPONSE</span>
                </div>
            {/foreach}
        </div><br>
        <div class="row margin-tb-20 UpdateAddFieldContainer hide padding-bottom1per">
			<span class="col-md-4">
            ...
            <span class="fieldUiHolder col-md-4 marginLeftZero">
                               <input type="text" class="inputElement row" name="fieldValue" {*data-rule-required="true"*} value="" placeholder="[0]" style="direction:ltr;text-align:left;"/>
			</span>
            <span class="cursorPointer span">
				<i class="alignMiddle deleteCondition fa fa-trash"></i>
			</span>
