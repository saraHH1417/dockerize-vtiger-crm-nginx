...
/** @class GlobalSearch_License_Js */
jQuery.Class('GlobalSearch_License_Js', {}, {
...
jQuery(document).ready(function(){
	var GlobalSearchLicenseInstance = new GlobalSearch_License_Js();
	GlobalSearchLicenseInstance.registerEvents();
})