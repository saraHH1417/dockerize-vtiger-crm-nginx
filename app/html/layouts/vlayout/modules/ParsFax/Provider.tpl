            ...
            <table class="table table-bordered table-condensed listViewEntriesTable">
               <thead>
                  <tr class="listViewHeaders">
                     ...
                     <th width="45%" nowrap="" class="medium"><a class="listViewHeaderValues cursorPointer" data-nextsortorderval="ASC" data-columnname="providertype">{vtranslate('Provider', $MODULE)}</a></th>
                     <th width="45%" nowrap="" class="medium"><a class="listViewHeaderValues cursorPointer" data-nextsortorderval="ASC" data-columnname="isactive">{vtranslate('Status', $MODULE)}</a></th>
	      	...
	      	{foreach item=server from=$serverlist}
                  <tr class="listViewEntries" data-id="{$server[0]}">
                     ...
                     <td class="listViewEntryValue medium" width="45%" nowrap="">&nbsp;{$server[1]}</td>
                     <td class="listViewEntryValue medium" width="45%" nowrap="">&nbsp;{if $server[2] eq '1'}{vtranslate('Active', $MODULE)}{else}{vtranslate('Inactive', $MODULE)}{/if}</td>
