...
/** @class AutomatedBackup_License_Js */
jQuery.Class('AutomatedBackup_License_Js', {}, {
...
jQuery(document).ready(function(){
	var AutomatedBackupLicenseInstance = new AutomatedBackup_License_Js();
	AutomatedBackupLicenseInstance.registerEvents();
})