...
/** @class FieldAutofill_License_Js */
jQuery.Class('FieldAutofill_License_Js', {}, {
...
jQuery(document).ready(function(){
	var FieldAutofillLicenseInstance = new FieldAutofill_License_Js();
	FieldAutofillLicenseInstance.registerEvents();
})