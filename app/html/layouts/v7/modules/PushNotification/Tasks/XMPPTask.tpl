...
<div class="row">
    <div class="col-lg-9">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('Host','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('Port','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('XMPP Username','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('XMPP Password','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('Target User','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
