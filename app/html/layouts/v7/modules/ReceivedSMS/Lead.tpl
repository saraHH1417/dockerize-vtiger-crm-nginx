...
<input data-link="true" value="&amp;nam=(FirstName)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Last Name', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input data-link="true" value="&amp;lnam=(LastName)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Email', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input data-link="true" value="&amp;mail=(Email)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Website', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input data-link="true" value="&amp;web=(Website)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Phone', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input data-link="true" value="&amp;phone=(Phone)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Fax', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input data-link="true" value="&amp;fax=(Fax)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Company', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input data-link="true" value="&amp;com=(Company)" type="checkbox" class="inputElement" style="width:15px;height:15px;">
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Lead Source', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select data-link="true" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$Listleadsource}</select>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Industry', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select data-link="true" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$ListIndustry}</select>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Assigned To', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select data-link="true" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>
<optgroup label="{vtranslate('Users', $MODULE)}">{$ListUsers}</optgroup>
<optgroup label="{vtranslate('Groups', $MODULE)}">{$ListGroups}</optgroup>
</select>
</span></td>
</tr>
            <tr><td colspan="4"><textarea id="myCode" name="update" cols="85" rows="4" STYLE="direction:ltr;" class="form-control" READONLY>{vglobal('site_URL')}modules/ReceivedSMS/capture.php?type=lead&amp;key={$sms_key}&amp;mob=(mobilenumber)&amp;to=(TO)&amp;msg=(smsmessage)</textarea>
