...
<table id="Keys" class="table table-bordered table-condensed themeTableColor" {if $DisplayTable4}style="display:none;"{/if}>
				<tbody>
            <tr><td colspan="2"><textarea id="myCode" name="update" cols="85" rows="4" STYLE="direction:ltr;" class="form-control" READONLY>{vglobal('site_URL')}modules/ReceivedSMS/capture.php?key={$sms_key}&amp;mob=(mobilenumber)&amp;to=(TO)&amp;msg=(smsmessage)
