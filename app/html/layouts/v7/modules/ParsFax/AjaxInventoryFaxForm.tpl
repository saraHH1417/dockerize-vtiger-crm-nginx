...
<div class='fc-overlay-modal'>
    <div class = "modal-content">
        ...
        <div class='modal-body' style="margin-bottom:100%;" id ="sendfaxContainer"  data-max="{$MAXPDF}">
            <hr>
            <form  style="overflow:auto;" class="form-horizontal" id="SendFax" method="post" action="index.php" enctype="multipart/form-data">
