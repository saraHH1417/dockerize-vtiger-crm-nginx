        ...
        <div class="col-sm-12 col-xs-12 content-area">
            <form class="form-horizontal fieldBlockContainer" method="post" action="index.php" onsubmit="return false;">
                ...
                <table class="table table-bordered listview-table" style="border-top: 1px solid #ddd;">
                    ...
                    <tr>
                        ...
                        <td class="fieldValue medium">
                            <div class="row-fluid">
                                <span><input type="checkbox" checked id ="action_add" name="action_add"> {vtranslate('Allow to Add New', $MODULE)}</span>
                            </div>
                        </td>
                    </tr>
                    </tbody>
            ...
            <div class="row-fluid">
                <table id="table-relations" class="table table-bordered listViewEntriesTable">
                    <caption style="font-weight: bold; font-size: 18px; padding: 10px;">
                        {vtranslate('All 1:M Relations', $MODULE)}</caption>
                    <thead>
