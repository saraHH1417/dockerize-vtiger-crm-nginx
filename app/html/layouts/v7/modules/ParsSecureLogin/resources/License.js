...
/** @class ParsSecureLogin_License_Js */
jQuery.Class('ParsSecureLogin_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ParsSecureLoginLicenseInstance = new ParsSecureLogin_License_Js();
	ParsSecureLoginLicenseInstance.registerEvents();
})