...
/** @class __ModuleName___License_Js */
jQuery.Class('__ModuleName___License_Js', {}, {
...
jQuery(document).ready(function(){
	var __ModuleName__LicenseInstance = new __ModuleName___License_Js();
	__ModuleName__LicenseInstance.registerEvents();
})