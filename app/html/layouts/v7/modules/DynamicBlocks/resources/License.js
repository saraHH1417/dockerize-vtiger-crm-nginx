...
/** @class DynamicBlocks_License_Js */
jQuery.Class('DynamicBlocks_License_Js', {}, {
...
jQuery(document).ready(function(){
	var DynamicBlocksLicenseInstance = new DynamicBlocks_License_Js();
	DynamicBlocksLicenseInstance.registerEvents();
})