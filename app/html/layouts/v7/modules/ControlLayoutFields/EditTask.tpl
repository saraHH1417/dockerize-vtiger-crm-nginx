            ...
            <div id="scrollContainer">
                <div class="modal-body tabbable">
                    ...
                    <div class="taskTypeUi row well">
                        <span class="col-lg-8">
                            <div>
                                <strong>{vtranslate('Set Field Values','ControlLayoutFields')}</strong>
                            </div>
                        </span>
                        ...
                        <div class="row col-lg-12">
                            <button class="btn btn-default addClfFieldBtn" type="button">{vtranslate('LBL_ADD_FIELDS','ControlLayoutFields')}</button>
                        </div>
                        <div class="basicAddFieldContainer hide clf-padding-top row">
                            ...
                            <span class="fieldUiHolder col-lg-6">
                                <select class="fieldOption clfcb" style="min-width: 220px;">
                                    {foreach key=KEY item=VALUE from=$FIELD_OPTIONS}
                                        <option value="{$KEY}">{vtranslate($VALUE,'ControlLayoutFields')}</option>
                                    {/foreach}
                                </select>
                            </span>
                            <span class="cursorPointer">
