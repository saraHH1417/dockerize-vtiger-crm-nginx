...
jQuery.Class("ControlLayoutFields_Upgrade_Js", {}, {
...
jQuery(document).ready(function () {
    var ControlLayoutFieldsUpgradeInstance = new ControlLayoutFields_Upgrade_Js();
    ControlLayoutFieldsUpgradeInstance.registerEvents();
})