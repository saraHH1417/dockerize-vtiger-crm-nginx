...
/** @class RecordCreator_License_Js */
jQuery.Class('RecordCreator_License_Js', {}, {
...
jQuery(document).ready(function(){
	var RecordCreatorLicenseInstance = new RecordCreator_License_Js();
	RecordCreatorLicenseInstance.registerEvents();
})