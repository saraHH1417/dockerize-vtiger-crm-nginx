...
/** @class ParsBadge_License_Js */
jQuery.Class('ParsBadge_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ParsBadgeLicenseInstance = new ParsBadge_License_Js();
	ParsBadgeLicenseInstance.registerEvents();
})