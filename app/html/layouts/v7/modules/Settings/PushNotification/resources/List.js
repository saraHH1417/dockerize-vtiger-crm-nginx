...
Settings_Vtiger_List_Js("Settings_PushNotification_List_Js",{},{
	...
	registerFilterChangeEvent : function() {
		...
		jQuery('#usersFilter').on('change',function(e){
			...
			var params = {
				...
				'search_value' : value,
				'page' : 1,
                'status' :this.options[this.selectedIndex].getAttribute("name")
			};
	...
	getDefaultParams : function() {
		...
		var params = {
			...
			'page' : pageNumber,
			'view' : "List",
			'status' : jQuery('select[id=usersFilter] option:selected').attr('name'),
			'search_key' : 'status',
