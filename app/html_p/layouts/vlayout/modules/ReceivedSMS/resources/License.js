...
/** @class ReceivedSMS_License_Js */
jQuery.Class('ReceivedSMS_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ReceivedSMSLicenseInstance = new ReceivedSMS_License_Js();
	ReceivedSMSLicenseInstance.registerEvents();
})