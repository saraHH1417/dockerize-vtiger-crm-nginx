...
Settings_Workflows_Edit_Js.prototype.toggleDiv = function() {
    ...
    jQuery('[name="content_type"]').on("change", function(result) {
        ...
        jQuery('#webhook_url_div').removeClass('span10');
        jQuery('#webhook_url_div').addClass('span8');
        ...
        if (content_type.val() == "SOAP") {
            ...
            jQuery('#webhook_url_div').removeClass('span8');
            jQuery('#webhook_url_div').addClass('span10');
