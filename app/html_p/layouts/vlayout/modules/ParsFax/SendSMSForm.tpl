...
-->*}
{strip}
    <div id="sendSmsContainer" class='modelContainer' style='min-width:900px;'>
                ...
                <div>
                    ...
                    {if $MODULE_IS_ACTIVE}
						...
						<button type="button" class="btn" id="selectEmailTemplate"
                                ...
                                title="{vtranslate('LBL_SELECT_EMAIL_TEMPLATE',$MODULE)}"><strong>{vtranslate('LBL_SELECT_EMAIL_TEMPLATE',$MODULE)}</strong></button>
					</span>
                    {/if}
                </div>
<div style="clear:both"></div>
                <div>
                    ...
                    &nbsp;(&nbsp;{vtranslate('LBL_SMS_MAX_CHARACTERS_ALLOWED',$MODULE)}&nbsp;)
                </div>
