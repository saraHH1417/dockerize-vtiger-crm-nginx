...
/** @class ListviewColors_License_Js */
jQuery.Class('ListviewColors_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ListviewColorsLicenseInstance = new ListviewColors_License_Js();
	ListviewColorsLicenseInstance.registerEvents();
})