...
/** @class Notifications_License_Js */
jQuery.Class('Notifications_License_Js', {}, {
...
jQuery(document).ready(function(){
	var NotificationsLicenseInstance = new Notifications_License_Js();
	NotificationsLicenseInstance.registerEvents();
})