...
{assign var=vibration value=$TASK_OBJECT->getVibration()}
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Key','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
        ...
        <div class="row-fluid">
            ...
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="s" style="min-width: 150px;">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Vibration','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="v" style="min-width: 150px;">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Icon','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="i" style="min-width: 150px;">
                    {for $foo=1 to 176}
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Picture URL','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
