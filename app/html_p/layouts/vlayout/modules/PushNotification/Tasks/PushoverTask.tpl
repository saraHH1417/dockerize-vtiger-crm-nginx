...
{assign var=sounds value=$TASK_OBJECT->getSounds()}
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Key/API Token','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('User/Group Key','PushNotification')}</div>
            <div class="span10">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Url','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Url Title','PushNotification')}</span>
            </div>
            <div class="span10">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Priority','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="priority" style="min-width: 150px;">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Retry (second)','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="retry" style="min-width: 150px;">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Expire Retry (second)','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="expire" style="min-width: 150px;">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Callback Url','PushNotification')}</div>
            <div class="span10">
        ...
        <div class="row-fluid">
            <div class="span2">{vtranslate('Sound','PushNotification')}<span class="redColor">*</span></div>
            <div class="span10">
                <select class="chzn-select task-fields" data-validation-engine='validate[required]' name="sound" style="min-width: 150px;">
