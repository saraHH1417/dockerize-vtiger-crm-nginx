...
/** @class RelatedRecordUpdate_License_Js */
jQuery.Class('RelatedRecordUpdate_License_Js', {}, {
...
jQuery(document).ready(function(){
	var RelatedRecordUpdateLicenseInstance = new RelatedRecordUpdate_License_Js();
	RelatedRecordUpdateLicenseInstance.registerEvents();
})