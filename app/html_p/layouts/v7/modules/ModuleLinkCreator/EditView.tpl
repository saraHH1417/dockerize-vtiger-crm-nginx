                            ...
                            <td class="fieldValue medium">
                                <div class="row-fluid ">
                                    <select id="Menu_Placement" name="menu_placement">
                                        <option value="MARKETING">{vtranslate('MARKETING', $MODULE)}</option>
                                        <option value="SALES">{vtranslate('SALES', $MODULE)}</option>
                                        <option value="INVENTORY">{vtranslate('INVENTORY', $MODULE)}</option>
                                        <option value="TOOLS">{vtranslate('TOOLS', $MODULE)}</option>
                                        <option value="SUPPORT">{vtranslate('SUPPORT', $MODULE)}</option>
                                        <option value="PROJECTS">{vtranslate('PROJECTS', $MODULE)}</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
    ...
    <div class="modal-dialog" role="document" style="width: 650px">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{vtranslate('LBL_CLOSE', $MODULE)}</button>
                <button type="button" class="btn btn-primary btn-submit">{vtranslate('LBL_SAVE', $MODULE)}</button>
            </div>
        </div>
    </div>
</div>