        ...
        <div class="row" style="margin-bottom: 20px">
            ...
            <div class="listViewActionsDiv row">
                <table style="margin: 0 auto;">
                    <tr>
                        <td>
                            <a id="Contacts_listView_basicAction_LBL_ADD_RECORD" target="_blank" href="index.php?module=ModuleLinkCreator&view=Edit" class="btn btn-default" style="background: #fff"><span class="fa fa-plus" aria-hidden="true"></span> {vtranslate('Custom Module', $MODULE)}</a>
                        </td>

                        <td>
                            <a  href="index.php?module={$MODULE}&parent=Settings&view=RelationshipOneOne" target="_blank" class="btn btn-default btn-info">{vtranslate('1:1 Relationship', $MODULE)}</a>
                        </td>
                        <td>
                            <a href="index.php?module=ModuleLinkCreator&parent=Settings&view=IndexRelatedFields" target="_blank" class="btn btn-default btn-info">{vtranslate('1:M Relationship', $MODULE)}</a>
                        </td>
                        <td>
                            <a href="index.php?module=ModuleLinkCreator&parent=Settings&view=RelationshipMM" target="_blank" class="btn btn-default btn-info">{vtranslate('M:M Relationship', $MODULE)}</a>
                        </td>
                        <td>
                            <a href="index.php?module=ModuleLinkCreator&parent=Settings&view=RelationshipOneNone" target="_blank" class="btn btn-default btn-info">{vtranslate('One Way Relationship', $MODULE)}</a>
                        </td>
                            ...
                            <tr class="emptyRecordsDiv">
                                <td colspan="5">
                                    <div class="emptyRecordsContent">
                                        ...
                                        {vtranslate('No modules found!', $MODULE)}
                                    </div>
                                </td>
                            </tr>
                        {/if}
