...
<div class="row">
    <div class="col-lg-9">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('Application key','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
        ...
        <div class="row form-group">
            <div class="col-lg-2">{vtranslate('Application secret','PushNotification')}<span class="redColor">*</span></div>
            <div class="col-lg-10">
