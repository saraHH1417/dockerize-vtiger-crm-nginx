...
<div class="container-fluid">
    <div class="contents">
        <form class="form-horizontal" action='index.php?module=PushNotification&parent=Settings&view=Settings&action=SaveSettings' method='POST'>
            <table class="table table-bordered table-condensed themeTableColor">
                ...
                <tr>
                    ...
                    <td class="row-fluid medium">
                        <select id="status" class="select2" name="status">{$WEBPUSHSTATUS}</select>
                    </td>
                </tr>
                {if $enable_webpush eq '1'}
                    <tr id="show1">
                        ...
                        <td class="row-fluid medium">
                            <select id="showicon" class="select2" name="showicon">{$ListWEBPUSH}</select>
                        </td>
                    </tr>
                {/if}
                </tbody>
            ...
            <table id="show5" class="table table-bordered table-condensed themeTableColor">
                <thead>
                <tr class="blockHeader">
                    <th colspan="2" class="medium">{vtranslate('Najva Settings', 'PushNotification')}</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td width="25%" class="medium">{vtranslate('Token Sender', 'PushNotification')}</td>
                    <td class="row-fluid medium">
                        <input type="text" name="najva_token" value="{$najva_token}"  style="direction:ltr; text-align:left">
                    </td>
                </tr>
                <tr>
                    <td width="25%" class="medium">{vtranslate('API Key', 'PushNotification')}</td>
                    <td class="row-fluid medium">
                        <input type="text" name="najva_apikey" value="{$najva_apikey}"  style="direction:ltr; text-align:left">
                    </td>
                </tr>
                <tr>
                    <td width="25%" class="medium">{vtranslate('Script', 'PushNotification')}</td>
                    <td class="row-fluid medium">
                        <textarea type="text" name="najva_script" style="direction:ltr; text-align:left">{$najva_script}</textarea>
                    </td>
                </tr>
                <tr>
                    <td width="25%" class="medium">{vtranslate('Content manifest.json', 'PushNotification')}</td>
                    <td class="row-fluid medium">
                        <textarea type="text" name="najva_manifest" style="direction:ltr; text-align:left">{$najva_manifest}</textarea>
                    </td>
                </tr>
