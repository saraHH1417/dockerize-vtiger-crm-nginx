...
Settings_Vtiger_List_Js("Settings_ParsSecureLogin_List_Js",{},{
	...
	registerFilterChangeEvent : function() {
		...
		jQuery('#searchbruteforcelist').on('click',function(e){
			jQuery('#pageNumber').val("1");
			jQuery('#pageToJump').val('1');
			jQuery('#orderBy').val('');
			jQuery("#sortOrder").val('');
			var value = jQuery('#bruteforcelist').val();
			
			var params = {
				module : app.getModuleName(),
				parent : app.getParentModuleName(),
				'search_key' : 'bruteforcelist',
				'search_value' : value,
				'page' : 1,
			};
