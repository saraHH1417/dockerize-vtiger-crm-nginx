			...
			<div class="col-lg-7 col-md-7 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
				...
				{if $VIEWID}
                    ...
                    <p class="current-filter-name filter-name pull-left cursorPointer"
                       title="{vtranslate($CVNAME,$MODULE)}"><span class="fa fa-angle-right pull-left"
                                                                   aria-hidden="true"></span><a
                                href='{$MODULE_MODEL->getListViewUrl()}&viewname={$VIEWID}&app={$SELECTED_MENU_CATEGORY}'>&nbsp;
				...
				{else if $smarty.request.view eq 'Edit' || $smarty.request.view eq 'SendFax'}
