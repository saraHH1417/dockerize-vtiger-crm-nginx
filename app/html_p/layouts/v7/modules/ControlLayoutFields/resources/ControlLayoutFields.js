...
Vtiger.Class("Control_Layout_Fields_Js", {}, {
                            ...
                            if (blockid > 0) {
                                ...
                                if (fields_on_conditions.length > 0) {
                                    $.each(fields_on_conditions, function (index, field_name) {
                                        ...
                                        if(this_field.length==0)this_field =$('.relatedblockslists' + blockid).find('tr.relatedRecords>td:nth-child(1)');//by Mahdi for custom field relation
                                                ...
                                                if (check_condition) {
                                                    jQuery.each(actions, function (index, value) {
                                                        ...
                                                        if (value.option == 'hide') {
                                                            ...
                                                            if(form_element.is('.ckEditorSource')) {
                                                                CKEDITOR.instances[value.field].setReadOnly(true);
                                                            }
                                                            parent_tr.find("[data-name *='" + value.field + "']").attr('readonly', 'readonly').attr('disabled', 'disabled');
                                                    ...
                                                    jQuery.each(actions, function (key, value) {
                                                        ...
                                                        if (form_element.length > 0) {
                                                            ...
                                                            if (form_element.hasClass(condition_key + '-clf-mandatory')) {
                                                                form_element.attr('data-rule-required', false);
                                                                form_element.attr('aria-invalid', false);
                                                                form_element.attr('aria-required', false);
                                                                form_element.attr('rule-illegal', false);
                                                                form_element.removeData('aria-invalid');
                                                                form_element.removeData('aria-required');
                                                                form_element.removeData('rule-required');
                                                                form_element.removeData('rule-illegal');
                                                                ...
                                                                if(form_element.is('.ckEditorSource')) {
                                                                    CKEDITOR.instances[value.field].setReadOnly(false);
                                                                }
                                                                parent_tr.find("[data-name *='" + value.field + "']").removeAttr('readonly').removeAttr('disabled');
                                ...
                                // alert(JSON.stringify(check_condition));
                                ...
                                if (check_condition) {
                                    jQuery.each(actions, function (key, value) {
                                        ...
                                        if (value.option == 'mandatory') {
                                            this_td.show();
                                            this_td.prev().show();
                                            form_element.data('rule-required', true);
                                            form_element.attr('aria-required', true);
                                            form_element.attr('aria-invalid', true);
                                            form_element.attr('rule-required', true);
                                            form_element.attr('rule-illegal', true);
                                            form_element.addClass(condition_key + '-clf-mandatory');
                                            var field_label = form_element.closest('td').prev();
                                            ...
                                            //Edit BY Mahdi(for custom filed)
                                            if(form_element.is('.ckEditorSource')){//html editor
                                                CKEDITOR.instances[value.field].setReadOnly(true);
                                            }
                                            jQuery('#EditView').find("[data-target *='" + value.field + "']").attr('readonly', 'readonly').attr('disabled', 'disabled').hide();//password
                                            jQuery('#EditView').find("[data-name *='" + value.field + "']").attr('readonly', 'readonly').attr('disabled', 'disabled');//other field (user list , city)
                                            jQuery('#EditView').find("[data-field_name *='" + value.field + "']").attr('readonly', 'readonly').attr('disabled', 'disabled');//delete button upload field
                                            jQuery('#EditView').find("[name *='" + value.field + "_time']").attr('readonly', 'readonly').attr('disabled', 'disabled');//date time field
                                            jQuery('#EditView').find("[name *='" + value.field + "_date']").attr('readonly', 'readonly').attr('disabled', 'disabled');//date time field
                                            jQuery('#EditView').find("[name *='upload_" + value.field + "[]']").attr('readonly', 'readonly').attr('disabled', 'disabled');//upload field
                                            jQuery("#donebutton" + value.field).attr('readonly', 'readonly').attr('disabled', 'disabled');//signature field
                                            jQuery("#clearbutton" + value.field).attr('readonly', 'readonly').attr('disabled', 'disabled');//signature field
                                            jQuery(".signEdit" + value.field).attr('readonly', 'readonly').attr('disabled', 'disabled');//signature field
                                            jQuery(".signDelete" + value.field).attr('readonly', 'readonly').attr('disabled', 'disabled');//signature field
                                            form_element.next('.star-rating').find('i').hide();//star rating field
                                            setTimeout(function () {
                                                form_element.next('.star-rating').find('i').hide();//star rating field
                                            },2000)
                                            form_element.next('.recording-field').hide();//recording field
                                            form_element.next('.jsgrid').hide();//jsgrid field
                                            jQuery('#EditView').find("[data-fieldname *='" + value.field + "']").parent().find('.relatedPopup').hide();//related field
                                            jQuery('#EditView').find("[data-fieldname *='" + value.field + "']").parent().find('.clearReferenceSelection').hide();//related field
                                            jQuery('#EditView').find("[data-fieldname *='" + value.field + "']").parent().next('.createReferenceRecord').hide();//related field
                                            form_element.next('.parsrepeater').find('input').attr('readonly', 'readonly').attr('disabled', 'disabled');//repeater field
                                            form_element.attr('readonly', 'readonly');
                                            form_element.attr('disabled', 'disabled');
                                            form_element.css('background', 'rgb(235, 235, 228)');
                                            form_element.addClass(condition_key + '-clf-read-only');
                                    ...
                                    jQuery.each(actions, function (key, value) {
                                        ...
                                        if (form_element.hasClass(condition_key + '-clf-read-only')) {
                                            ...
                                            jQuery('#EditView').find("[data-target *='" + value.field + "']").removeAttr('readonly').removeAttr('disabled').show();
                                            jQuery('#EditView').find("[data-name *='" + value.field + "']").removeAttr('readonly').removeAttr('disabled');
                                            jQuery('#EditView').find("[data-field_name *='" + value.field + "']").removeAttr('readonly').removeAttr('disabled');
                                            jQuery('#EditView').find("[name *='" + value.field + "_time']").removeAttr('readonly').removeAttr('disabled');
                                            jQuery('#EditView').find("[name *='" + value.field + "_date']").removeAttr('readonly').removeAttr('disabled');
                                            jQuery('#EditView').find("[name *='upload_" + value.field + "[]']").removeAttr('readonly').removeAttr('disabled');
                                            jQuery("#donebutton" + value.field).removeAttr('readonly').removeAttr('disabled');
                                            jQuery("#clearbutton" + value.field).removeAttr('readonly').removeAttr('disabled');
                                            jQuery(".signEdit" + value.field).removeAttr('readonly').removeAttr('disabled');
                                            jQuery(".signDelete" + value.field).removeAttr('readonly').removeAttr('disabled');
                                            form_element.next('.star-rating').find('i').show();//star rating field
                                            form_element.next('.recording-field').show();//srecording field
                                            form_element.next('.jsgrid').show();//jsgrid field
                                            jQuery('#EditView').find("[data-fieldname *='" + value.field + "']").parent().find('.relatedPopup').show();//related field
                                            jQuery('#EditView').find("[data-fieldname *='" + value.field + "']").parent().find('.clearReferenceSelection').show();//related field
                                            jQuery('#EditView').find("[data-fieldname *='" + value.field + "']").parent().next('.createReferenceRecord').show();//related field
                                            form_element.next('.parsrepeater').find('input').removeAttr('readonly').removeAttr('disabled');//repeater field
                                            form_element.removeAttr('readonly');
                                            form_element.removeAttr('disabled');
                                            form_element.css('background', 'white');
                                            form_element.removeClass(condition_key + '-clf-read-only');
                        ...
                        jQuery.each(data.clf_info, function (k, v) {
                            ...
                            if (blockid > 0) {
                                                ...
                                                if (check_condition) {
                                                    ...
                                                    jQuery.each(actions, function (index, value) {
                                                        ...
                                                        if (value.option == 'hide') {
                                                            ...
                                                            var target_element = target_td.find('[name=' + value.field + ']');
                                                            if (target_element.length > 0) {
                                                                target_element.attr('data-rule-required', false);
                                                                target_element.removeData('rule-required');
                                                                if (target_element.is('select')) target_element.trigger('liszt:updated');
                                                            }
                                                        }
                                                    });
                                ...
                                if (check_condition) {
                                    ...
                                    //return false;
                                }else if(requestMode!='full'){

                                    jQuery.each(actions, function (index, value) {
                                        var form_element = jQuery('[data-name="' + value.field + '"]').closest('div.row');
                                        form_element.find('a.editAction').remove()
                                        form_element.find('span.edit').remove()
                                    })
                                }
    ...
    checkCondition: function (form_element_value, comparator, field_value, field_name_changed, field_name) {
        ...
        //by mahdi (convert type to string)
    ...
    checkConditionToForm: function (all_condition, any_condition, field_name_changed, record_info, role_id, new_value) {
        ...
        if (any_condition.length == 0) is_any = true;
                            ...
                            if (check_condition) {
                                jQuery.each(actions, function (key, value) {
                                    ...
                                    if (value.option == 'mandatory') {
                                        ...
                                        jQuery('#vteButtonQuickEdit').find("[data-name *='" + value.field + "']").attr('readonly', 'readonly').attr('disabled', 'disabled');
                                        form_element.attr('readonly', 'readonly');
                                        form_element.attr('disabled', 'disabled');
                                        form_element.css('background', 'rgb(235, 235, 228)');
                                        form_element.addClass(condition_key + '-clf-read-only');
                                ...
                                jQuery.each(actions, function (key, value) {
                                    ...
                                    if (form_element.hasClass(condition_key + '-clf-read-only')) {
                                        ...
                                        jQuery('#vteButtonQuickEdit').find("[data-name *='" + value.field + "']").removeAttr('readonly').removeAttr('disabled');
                                        form_element.removeAttr('readonly');
                                        form_element.removeAttr('disabled');
                                        form_element.css('background', 'white');
                                        form_element.removeClass(condition_key + '-clf-read-only');
...
jQuery(document).ajaxComplete(function (event, xhr, settings) {
    ...
    if (array_url.view == 'Detail' && other_url.action == 'SaveAjax') {
        ...
        //by Mahdi (load tab related module)
        if (other_url.displayMode == 'overlay' && other_url.view == 'Edit' && other_url.returnrelatedModuleName) {
            var module = other_url.returnrelatedModuleName;
