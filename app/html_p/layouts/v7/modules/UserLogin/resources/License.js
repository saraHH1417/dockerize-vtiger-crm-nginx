...
/** @class UserLogin_License_Js */
jQuery.Class('UserLogin_License_Js', {}, {
...
jQuery(document).ready(function(){
	var UserLoginLicenseInstance = new UserLogin_License_Js();
	UserLoginLicenseInstance.registerEvents();
})