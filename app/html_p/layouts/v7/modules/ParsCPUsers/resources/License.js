...
/** @class ParsCPUsers_License_Js */
jQuery.Class('ParsCPUsers_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ParsCPUsersLicenseInstance = new ParsCPUsers_License_Js();
	ParsCPUsersLicenseInstance.registerEvents();
})