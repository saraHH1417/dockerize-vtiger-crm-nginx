...
/** @class ParsVTExtras_License_Js */
jQuery.Class('ParsVTExtras_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ParsVTExtrasLicenseInstance = new ParsVTExtras_License_Js();
	ParsVTExtrasLicenseInstance.registerEvents();
})