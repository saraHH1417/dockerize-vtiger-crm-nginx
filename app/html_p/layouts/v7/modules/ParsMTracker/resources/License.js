...
/** @class ParsMTracker_License_Js */
jQuery.Class('ParsMTracker_License_Js', {}, {
...
jQuery(document).ready(function(){
	var ParsMTrackerLicenseInstance = new ParsMTracker_License_Js();
	ParsMTrackerLicenseInstance.registerEvents();
})