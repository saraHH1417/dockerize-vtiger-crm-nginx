...
<input id="mob" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="mob" value="{$mob}" required="required"></span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('To', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="to" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="to" value="{$to}" required="required"></span></td>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Message', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="msg" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="msg" value="{$msg}" required="required"></span></td>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Mode', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select id="type" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px" name="type"><option value=""> --- </option>{$ListMode}</select>
</span></td>
</tr>
...
<td class="fieldValue medium"><span class="span10">
<input id="separate" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="separate" value="{$separate}"></span></td>
</span></td>
...
<td class="fieldValue medium"><span class="span10">
<input id="nam" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="nam" value="{$nam}"></span></td>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Last Name', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="lnam" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="lnam" value="{$lnam}"></span></td>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Email', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="mail" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="mail" value="{$mail}"></span></td>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Website', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="web" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="web" value="{$web}"></span></td>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Phone', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="phone" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="phone" value="{$phone}"></span></td>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Fax', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="fax" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="fax" value="{$fax}"></span></td>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Company', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<input id="com" type="text" class="inputElement"  style="width:200px" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="com" value="{$com}"></span></td>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Lead Source', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="source" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$Listleadsource}</select>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Industry', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="industry" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$ListIndustry}</select>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Assigned To', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="assignto"  data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>
...
<td class="fieldValue medium"><span class="span10">
<input id="sub" type="text" class="inputElement" data-validation-engine="validate[required,funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="sub" value="{$sub}"></span></td>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Status', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="status" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$Listticketstatus}</select>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Category', 'HelpDesk')}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="cat" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$Listcategories}</select>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Priority', 'HelpDesk')}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="priority" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$Listpriorities}</select>
</span></td>
</tr>
<tr>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('LBL_SEVERITY', 'HelpDesk')}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="severities"  data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>{$Listseverities}</select>
</span></td>
<td class="fieldLabel medium"><label class="muted pull-right marginRight10px">{vtranslate('Assigned To', $MODULE)}</label></td>
<td class="fieldValue medium"><span class="span10">
<select name="tassignto" data-link="true" data-fieldtype="picklist" class="inputElement select2  select2-offscreen" type="picklist" style="width:200px"><option></option>
...
<optgroup label="{vtranslate('Groups', $MODULE)}">{str_replace("assignto","tassignto",$TListGroups)}</optgroup>
            ...
            <tr><td colspan="4">
<textarea id="myCode" cols="85" rows="4" STYLE="direction:ltr;" class="form-control" READONLY>{vglobal('site_URL')}modules/ReceivedSMS/custom.php</textarea></td></tr>
