...
<optgroup label="{vtranslate('Groups', $MODULE)}">{str_replace("assignto","tassignto",$ListGroups)}</optgroup>
            ...
            <tr><td colspan="4"><textarea id="myCode" name="update" cols="85" rows="4" STYLE="direction:ltr;" class="form-control" READONLY>{vglobal('site_URL')}modules/ReceivedSMS/capture.php?type=advmode&amp;key={$sms_key}&amp;separate=(startwith)&amp;mob=(mobilenumber)&amp;to=(TO)&amp;msg=(smsmessage)</textarea>
