				...
				foreach($delta as $fieldName => $values) {
					if($fieldName != 'modifiedtime') {
						if(!$inserted) {
							...
							$changedOn = !strtotime($newerColumnFields['modifiedtime']) || is_null($newerColumnFields['modifiedtime']) ? date("Y-m-d H:i:s") : date("Y-m-d H:i:s", strtotime($newerColumnFields['modifiedtime']));
							if($moduleName == 'Users') {
