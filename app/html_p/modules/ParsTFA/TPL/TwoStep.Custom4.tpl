				...
				<div class="span12">
					<div class="content-wrapper">
							...
							<div class="row-fluid">
								<div class="span12">
									<div style='direction:rtl'>
										<div class="login-box" id="loginDiv" style="height: {if isset($smarty.request.status)}430{else}350{/if}px;">
											<div class="">
											...
											<form class="form-horizontal login-form" style="margin:0;"  action="index.php?module=Users&action=StepTwo" method="post">
												...
												<div class="control-group">
		                                                                               	...
		                                                                               	<div class="control-group">
													<label class="control-label" for="totpPin"><b>{vtranslate('Security Code:',$MODULE)}</b></label>
			                                                                         	<div class="controls">
														<input type="tel"  pattern="[0-9 ]*" id="totpPin" name="Pin" dir="ltr" autocomplete="off"  autofocus="" placeholder="{vtranslate('Enter Security Code',$MODULE)}"><br />
                     ...
                     <a href="index.php?module=Users&parent=Settings&view=StepTwo&ChangeUser={$USERID}">{vtranslate('Try sign in with another user','Users')}</a>
                      <br /><button type="submit" class="btn btn-primary sbutton">{vtranslate('Sign in')}</button>
                                                                                                </div>
